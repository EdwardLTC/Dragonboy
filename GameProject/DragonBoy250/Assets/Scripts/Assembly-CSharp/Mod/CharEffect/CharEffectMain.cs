...
{
	internal static class CharEffectMain
	{
		internal static bool isEnabled;

		static readonly List<Char> storedChars = new List<Char>();

		static bool isNRDAdded, isTieAdded, isTDHSAdded, isMobMeAdded, isMonkeyAdded;
		...
		{
			charEffectImages = new[]
			{
				GameCanvas.loadImage("/CharEffect/nrd1"), GameCanvas.loadImage("/CharEffect/nrd2"), GameCanvas.loadImage("/CharEffect/nrd3"), GameCanvas.loadImage("/CharEffect/nrd4"), GameCanvas.loadImage("/CharEffect/nrd5"), GameCanvas.loadImage("/CharEffect/nrd6"), GameCanvas.loadImage("/CharEffect/nrd7"), GameCanvas.loadImage("/CharEffect/shield"), GameCanvas.loadImage("/CharEffect/monkey"), GameCanvas.loadImage("/CharEffect/whistle"), GameCanvas.loadImage("/CharEffect/mobme"), GameCanvas.loadImage("/CharEffect/hypnotize"), GameCanvas.loadImage("/CharEffect/teleport"), GameCanvas.loadImage("/CharEffect/blind"), GameCanvas.loadImage("/CharEffect/tie"), GameCanvas.loadImage("/CharEffect/stone"), GameCanvas.loadImage("/CharEffect/choco"), GameCanvas.loadImage("/CharEffect/selfexplode"), GameCanvas.loadImage("/CharEffect/nrnm"), GameCanvas.loadImage("/CharEffect/qckk")
			};
		}
		...
		static void removeElement(ItemTime item)
		{
