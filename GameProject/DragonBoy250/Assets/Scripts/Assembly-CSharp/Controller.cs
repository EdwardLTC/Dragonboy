		...
		try
		{
			...
			case -95:
			{
				...
				if (b16 == 0)
				{
					...
					{
						Char.myCharz().mobMe = new Mob(num27, false, false, false, false, false, templateId, 1, num28, 0, num28, (short)(Char.myCharz().cx + ((Char.myCharz().cdir != 1) ? (-40) : 40)), (short)Char.myCharz().cy, 4, 0);
					...
					else
					{
						...
						if (obj != null)
						{
							Mob mob3 = new Mob(num27, false, false, false, false, false, templateId, 1, num28, 0, num28, (short)obj.cx, (short)obj.cy, 4, 0);
							mob3.isMobMe = true;
							obj.mobMe = mob3;
						...
						else
						{
							...
							if (mob4 == null)
							{
								mob4 = new Mob(num27, false, false, false, false, false, templateId, 1, num28, 0, num28, -100, -100, 4, 0);
								mob4.isMobMe = true;
				...
				if (b16 == 2)
				{
					...
					if (num30 == Char.myCharz().charID)
					{
						...
						if (obj != null)
						{
							...
							{
								obj.doInjure(num32, 0L, false, true);
							}
							else
							{
					...
					else
					{
						...
						if (mob != null)
						{
							if (num31 == Char.myCharz().charID)
							{
								...
								{
									Char.myCharz().doInjure(num32, 0L, false, true);
								}
								else
								{
									mob.dame = num32;
				...
				if (b16 == 6)
				{
					...
					{
						obj = GameScr.findCharInMap(num38);
						if (obj != null)
						{
							obj.mobMe.startDie();
						}
			...
			case -67:
			{
				...
				{
					array17 = null;
					SmallImage.imgNew[num154].img = Image.createRGBImage(new int[1], 1, 1, true);
				}
			...
			case -32:
			{
				...
				{
					array11 = null;
					BgItem.imgNew.put(num135 + string.Empty, Image.createRGBImage(new int[1], 1, 1, true));
				}
				if (array11 != null)
				{
			...
			case -11:
			{
				...
				if (mob9 != null)
				{
					...
					{
						Char.myCharz().doInjure(num170, num171, false, true);
						break;
					}
					mob9.dame = num170;
					mob9.dameMp = num171;
