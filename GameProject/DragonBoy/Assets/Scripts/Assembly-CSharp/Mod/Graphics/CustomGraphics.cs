...
namespace Mod.Graphics
{
	internal static class CustomGraphics
	{
		...
		{
			0, 0, 0, 0, 600841, 3346944, 3932211, 6684682
		};
		...
		{
			DrawCircle(color, (mapObject.getX() - GameScr.cmx) * mGraphics.zoomLevel, (mapObject.getY() - GameScr.cmy) * mGraphics.zoomLevel, radius * mGraphics.zoomLevel, thickness * mGraphics.zoomLevel);
		}
