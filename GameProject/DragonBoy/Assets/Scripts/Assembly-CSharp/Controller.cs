...
public class Controller : IMessageHandler
{
    ...
    public void onMessage(Message msg)
    {
        ...
        try
        {
            ...
            switch (command)
            {
                default:
                    if (command != -112)
                    {
                        ...
                        {
                            var num28 = msg.reader().readShort();
                            ...
                            if (num30 != 0)
                            {
                                ...
                                for (var num31 = 0; num31 < Char.myPetz().arrItemBody[num27].itemOption.Length; num31++)
                                {
                                    int num32 = msg.reader().readUnsignedByte();
                                    int param = msg.reader().readUnsignedShort();
                                    if (num32 != -1)
                                        Char.myPetz().arrItemBody[num27].itemOption[num31] =
                                            new ItemOption(num32, param);
                                }
                            }

                            if (num29 == 0)
                                Char.myPetz().body = Char.myPetz().arrItemBody[num27].template.part;
                            else if (num29 == 1) Char.myPetz().leg = Char.myPetz().arrItemBody[num27].template.part;
                        }
                        ...
                        for (var num33 = 0; num33 < Char.myPetz().arrPetSkill.Length; num33++)
                        {
                            var num34 = msg.reader().readShort();
                            if (num34 != -1)
                            {
                ...
                case 65:
                {
                    var b40 = msg.reader().readSByte();
                    var text5 = msg.reader().readUTF();
                    var num108 = msg.reader().readShort();
                ...
                case 112:
                {
                    ...
                    else
                    {
                        ...
                        for (var num35 = 0; num35 < b18; num35++)
                        {
                            GameCanvas.panel.speacialTabName[num35] = new string[2];
                            var array4 = Res.split(msg.reader().readUTF(), "\n", 0);
                            if (array4.Length == 2)
                ...
                case -98:
                {
                    var b24 = msg.reader().readByte();
                    GameCanvas.menu.showMenu = false;
                    if (b24 == 0)
                        GameCanvas.startYesNoDlg(msg.reader().readUTF(),
                            new Command(mResources.YES, GameCanvas.instance, 888397, msg.reader().readUTF()),
                            new Command(mResources.NO, GameCanvas.instance, 888396, null));
                    break;
                }
                case -97:
                ...
                case -96:
                {
                    var typeTop = msg.reader().readByte();
                    GameCanvas.panel.vTop.removeAllElements();
                    var topName = msg.reader().readUTF();
                    var b14 = msg.reader().readByte();
                    for (var num25 = 0; num25 < b14; num25++)
                    {
                        var rank = msg.reader().readInt();
                        var pId = msg.reader().readInt();
                        var headID = msg.reader().readShort();
                        var headICON = msg.reader().readShort();
                        var body = msg.reader().readShort();
                        var leg = msg.reader().readShort();
                        var name = msg.reader().readUTF();
                        var info = msg.reader().readUTF();
                ...
                case -94:
                    ...
                    {
                        var num41 = msg.reader().readShort();
                        var num42 = msg.reader().readInt();
                        for (var num43 = 0; num43 < Char.myCharz().vSkill.size(); num43++)
                        {
                            var skill = (Skill)Char.myCharz().vSkill.elementAt(num43);
                            if (skill != null && skill.skillId == num41)
                            {
                                ...
                                Res.outz("1 chieu id= " + skill.template.id + " cooldown= " + num42 +
                                         "curr cool down= " + skill.coolDown);
                            }
                        }
                    }
                ...
                case -95:
                {
                    var b43 = msg.reader().readByte();
                    Res.outz("type= " + b43);
                    if (b43 == 0)
                    {
                        var num115 = msg.reader().readInt();
                        var templateId = msg.reader().readShort();
                        var num116 = msg.readInt3Byte();
                        SoundMn.gI().explode_1();
                        if (num115 == Char.myCharz().charID)
                        {
                            Char.myCharz().mobMe = new Mob(num115, false, false, false, false, false, templateId, 1,
                                num116, 0, num116, (short)(Char.myCharz().cx + (Char.myCharz().cdir != 1 ? -40 : 40)),
                                (short)Char.myCharz().cy, 4, 0);
                        ...
                        else
                        {
                            ...
                            if (@char != null)
                            {
                                var mob5 = new Mob(num115, false, false, false, false, false, templateId, 1, num116, 0,
                                    num116, (short)@char.cx, (short)@char.cy, 4, 0);
                                mob5.isMobMe = true;
                                @char.mobMe = mob5;
                            ...
                            {
                                var mob6 = new Mob(num115, false, false, false, false, false, templateId, 1, num116, 0,
                                    num116, -100, -100, 4, 0);
                                mob6.isMobMe = true;
                    ...
                    if (b43 == 2)
                    {
                        var num118 = msg.reader().readInt();
                        var num119 = msg.reader().readInt();
                        var num120 = msg.readInt3Byte();
                        var cHPNew = msg.readInt3Byte();
                    ...
                    if (b43 == 3)
                    {
                        var num121 = msg.reader().readInt();
                        var mobId2 = msg.reader().readInt();
                        var hp = msg.readInt3Byte();
                        var num122 = msg.readInt3Byte();
                        @char = null;
                    ...
                    if (b43 == 5)
                    {
                        var num123 = msg.reader().readInt();
                        var b44 = msg.reader().readByte();
                        var mobId3 = msg.reader().readInt();
                        var num124 = msg.readInt3Byte();
                        var hp2 = msg.readInt3Byte();
                        @char = null;
                        ...
                        var mob7 = GameScr.findMobInMap(mobId3);
                        if (@char.cx <= mob7.x)
                            @char.cdir = 1;
                        else
                            @char.cdir = -1;
                    ...
                    if (b43 != 7)
                        break;
                    var num126 = msg.reader().readInt();
                    if (num126 == Char.myCharz().charID)
                    {
                        Char.myCharz().mobMe = null;
                        for (var num127 = 0; num127 < GameScr.vMob.size(); num127++)
                    ...
                    for (var num128 = 0; num128 < GameScr.vMob.size(); num128++)
                ...
                case -90:
                {
                    var b31 = msg.reader().readByte();
                    var num73 = msg.reader().readInt();
                    Res.outz("===> UPDATE_BODY:    type = " + b31);
                    @char = Char.myCharz().charID != num73 ? GameScr.findCharInMap(num73) : Char.myCharz();
                    if (b31 != -1)
                    {
                        var num74 = msg.reader().readShort();
                        var num75 = msg.reader().readShort();
                        var num76 = msg.reader().readShort();
                        var isMonkey = msg.reader().readByte();
                        if (@char != null)
                        {
                    ...
                    if (@char == null)
                        break;
                    for (var num77 = 0; num77 < 54; num77++) @char.removeEffChar(0, 201 + num77);
                    if (@char.bag >= 201 && @char.bag < 255)
                    {
                        var effect = new Effect(@char.bag, @char, 2, -1, 10, 1);
                        effect.typeEff = 5;
                    ...
                    for (var num78 = 0; num78 < Char.myCharz().arrItemBag.Length; num78++)
                    {
                        var item3 = Char.myCharz().arrItemBag[num78];
                        if (item3 == null)
                            continue;
                ...
                case -87:
                {
                    ...
                    msg.reader().reset();
                    var data2 = new sbyte[msg.reader().available()];
                    msg.reader().readFully(ref data2);
                    Rms.saveRMS("NRdataVersion", new sbyte[1] { GameScr.vcData });
                    LoginScr.isUpdateData = false;
                    if (GameScr.vsData == GameScr.vcData && GameScr.vsMap == GameScr.vcMap &&
                        GameScr.vsSkill == GameScr.vcSkill && GameScr.vsItem == GameScr.vcItem)
                    {
                ...
                case -86:
                {
                    var b26 = msg.reader().readByte();
                    Res.outz("server gui ve giao dich action = " + b26);
                    if (b26 == 0)
                    {
                        var playerID = msg.reader().readInt();
                        GameScr.gI().giaodich(playerID);
                    }

                    if (b26 == 1)
                    {
                        var num60 = msg.reader().readInt();
                        var char8 = GameScr.findCharInMap(num60);
                        if (char8 == null)
                            return;
                    ...
                    if (b26 == 2)
                    {
                        var b27 = msg.reader().readByte();
                        for (var num61 = 0; num61 < GameCanvas.panel.vMyGD.size(); num61++)
                        {
                            var item = (Item)GameCanvas.panel.vMyGD.elementAt(num61);
                            if (item.indexUI == b27)
                            {
                    ...
                    if (b26 == 6)
                    {
                        ...
                        var friendMoneyGD = msg.reader().readInt();
                        var b28 = msg.reader().readByte();
                        Res.outz("item size = " + b28);
                        for (var num62 = 0; num62 < b28; num62++)
                        {
                            var item2 = new Item();
                            ...
                            if (num63 != 0)
                            {
                                ...
                                for (var num64 = 0; num64 < item2.itemOption.Length; num64++)
                                {
                ...
                case -85:
                {
                    ...
                    var b6 = msg.reader().readByte();
                    if (b6 == 0)
                    {
                        int num12 = msg.reader().readUnsignedShort();
                        Res.outz("lent =" + num12);
                        var data = new sbyte[num12];
                ...
                case -81:
                {
                    var b57 = msg.reader().readByte();
                    if (b57 == 0)
                    {
                        var src = msg.reader().readUTF();
                        var src2 = msg.reader().readUTF();
                    ...
                    if (b57 == 1)
                    {
                        ...
                        var b58 = msg.reader().readByte();
                        for (var num148 = 0; num148 < b58; num148++)
                        {
                            var b59 = msg.reader().readByte();
                            for (var num149 = 0; num149 < Char.myCharz().arrItemBag.Length; num149++)
                            {
                                var item4 = Char.myCharz().arrItemBag[num149];
                    ...
                    if (b57 == 4)
                    {
                        var iconID = msg.reader().readShort();
                    ...
                    if (b57 == 5)
                    {
                        var iconID2 = msg.reader().readShort();
                    ...
                    if (b57 == 6)
                    {
                        var iconID3 = msg.reader().readShort();
                        var iconID4 = msg.reader().readShort();
                        GameCanvas.panel.combineSuccess = 0;
                    ...
                    if (b57 == 7)
                    {
                        var iconID5 = msg.reader().readShort();
                    ...
                    for (var num153 = 0; num153 < GameScr.vNpc.size(); num153++)
                    {
                        var npc6 = (Npc)GameScr.vNpc.elementAt(num153);
                ...
                case -80:
                {
                    var b34 = msg.reader().readByte();
                    InfoDlg.hide();
                    if (b34 == 0)
                    {
                        GameCanvas.panel.vFriend.removeAllElements();
                        int num85 = msg.reader().readUnsignedByte();
                        for (var num86 = 0; num86 < num85; num86++)
                        {
                            var char9 = new Char();
                            ...
                            var isOnline = msg.reader().readBoolean();
                            var infoItem = new InfoItem(mResources.power + ": " + msg.reader().readUTF());
                    ...
                    if (b34 == 3)
                    {
                        var vFriend = GameCanvas.panel.vFriend;
                        var num87 = msg.reader().readInt();
                        Res.outz("online offline id=" + num87);
                        for (var num88 = 0; num88 < vFriend.size(); num88++)
                        {
                            var infoItem2 = (InfoItem)vFriend.elementAt(num88);
                    ...
                    if (b34 != 2)
                        break;
                    var vFriend2 = GameCanvas.panel.vFriend;
                    var num89 = msg.reader().readInt();
                    for (var num90 = 0; num90 < vFriend2.size(); num90++)
                    {
                        var infoItem3 = (InfoItem)vFriend2.elementAt(num90);
                ...
                case -99:
                    ...
                    if (msg.reader().readByte() == 0)
                    {
                        ...
                        for (var num92 = 0; num92 < num91; num92++)
                        {
                            var char10 = new Char();
                            ...
                            var infoItem4 = new InfoItem(msg.reader().readUTF());
                            var flag7 = msg.reader().readBoolean();
                ...
                {
                    InfoDlg.hide();
                    var num9 = msg.reader().readInt();
                    var charMenu = GameCanvas.panel.charMenu;
                    if (charMenu == null)
                        return;
                ...
                case -93:
                {
                    var num19 = msg.reader().readShort();
                    BgItem.newSmallVersion = new sbyte[num19];
                    for (var m = 0; m < num19; m++) BgItem.newSmallVersion[m] = msg.reader().readByte();
                    break;
                }
                case -77:
                {
                    var num164 = msg.reader().readShort();
                    SmallImage.newSmallVersion = new sbyte[num164];
                    SmallImage.maxSmall = num164;
                    SmallImage.imgNew = new Small[num164];
                    for (var num165 = 0; num165 < num164; num165++)
                        SmallImage.newSmallVersion[num165] = msg.reader().readByte();
                    break;
                }
                case -76:
                {
                    var b60 = msg.reader().readByte();
                    if (b60 == 0)
                    {
                        var b61 = msg.reader().readByte();
                        if (b61 <= 0)
                            return;
                        Char.myCharz().arrArchive = new Archivement[b61];
                        for (var num154 = 0; num154 < b61; num154++)
                        {
                ...
                case -74:
                {
                    ...
                    if (!GameCanvas.isGetResourceFromServer())
                    {
                        ...
                        if (Rms.loadRMSString("acc") != null ||
                            Rms.loadRMSString("userAo" + ServerListScreen.ipSelect) != null)
                    ...
                    var flag9 = true;
                    var b42 = msg.reader().readByte();
                    if (b42 == 0)
                    {
                        var num111 = msg.reader().readInt();
                        var text6 = Rms.loadRMSString("ResVersion");
                        var num112 = text6 == null || !(text6 != string.Empty) ? -1 : int.Parse(text6);
                        if (text6 != null)
                    ...
                    if (b42 == 2)
                        try
                        {
                            ...
                            var array9 = Res.split(msg.reader().readUTF(), "/", 0);
                            var filename = "x" + mGraphics.zoomLevel + array9[array9.Length - 1];
                            var num113 = msg.reader().readInt();
                            var data3 = new sbyte[num113];
                ...
                case -43:
                {
                    var itemAction = msg.reader().readByte();
                    var where = msg.reader().readByte();
                    var index2 = msg.reader().readByte();
                    var info3 = msg.reader().readUTF();
                ...
                case -59:
                {
                    ...
                    GameScr.gI().player_vs_player(msg.reader().readInt(), msg.reader().readInt(),
                        msg.reader().readUTF(), typePK);
                    break;
                }
                case -62:
                {
                    int num109 = msg.reader().readUnsignedByte();
                    var b41 = msg.reader().readByte();
                    if (b41 <= 0)
                        break;
                    var clanImage3 = ClanImage.getClanImage((short)num109);
                    if (clanImage3 == null)
                        break;
                    clanImage3.idImage = new short[b41];
                    for (var num110 = 0; num110 < b41; num110++)
                    {
                ...
                case -65:
                {
                    ...
                    if (Char.myCharz().charID == num17)
                    {
                        ...
                        if (b7 == 0 || b7 == 1 || b7 == 3)
                            Teleport.addTeleport(new Teleport(Char.myCharz().cx, Char.myCharz().cy, Char.myCharz().head,
                                Char.myCharz().cdir, 0, true, b7 != 1 ? b7 : Char.myCharz().cgender));
                        if (b7 == 2)
                        {
                            GameScr.lockTick = 50;
                            Char.myCharz().hide();
                    ...
                    {
                        var char6 = GameScr.findCharInMap(num17);
                        if ((b7 == 0 || b7 == 1 || b7 == 3) && char6 != null)
                        {
                            char6.isUsePlane = true;
                            var teleport = new Teleport(char6.cx, char6.cy, char6.head, char6.cdir, 0, false,
                                b7 != 1 ? b7 : char6.cgender);
                            teleport.id = num17;
                ...
                case -64:
                {
                    ...
                    if (@char == null)
                        return;
                    @char.bag = num95;
                    for (var num96 = 0; num96 < 54; num96++) @char.removeEffChar(0, 201 + num96);
                    if (@char.bag >= 201 && @char.bag < 255)
                    {
                        var effect2 = new Effect(@char.bag, @char, 2, -1, 10, 1);
                        effect2.typeEff = 5;
                        @char.addEffChar(effect2);
                    }

                    Res.outz("cmd:-64 UPDATE BAG PLAER = " + (@char != null ? @char.cName : string.Empty) + num94 +
                             " BAG ID= " + num95);
                    if (num95 == 30 && @char.me)
                        GameScr.isPickNgocRong = true;
                    break;
                ...
                case -57:
                {
                    var strInvite = msg.reader().readUTF();
                    var clanID = msg.reader().readInt();
                    var code = msg.reader().readInt();
                ...
                case -53:
                {
                    ...
                    for (var num171 = 0; num171 < Char.myCharz().clan.currMember; num171++)
                    {
                    ...
                    for (var num173 = 0; num173 < num172; num173++) readClanMsg(msg, -1);
                ...
                case -52:
                {
                    ...
                    if (b35 == 2)
                    {
                        ...
                        for (var num97 = 0; num97 < GameCanvas.panel.myMember.size(); num97++)
                        {
                            var member4 = (Member)GameCanvas.panel.myMember.elementAt(num97);
                ...
                case -47:
                {
                    ...
                    else
                    {
                        ...
                        for (var num59 = 0; num59 < GameCanvas.panel.clans.Length; num59++)
                        {
                ...
                {
                    InfoDlg.hide();
                    var b29 = msg.reader().readByte();
                    if (b29 == 1 || b29 == 3)
                    {
                        GameCanvas.endDlg();
                        ClanImage.vClanImage.removeAllElements();
                        int num66 = msg.reader().readUnsignedByte();
                        for (var num67 = 0; num67 < num66; num67++)
                        {
                            var clanImage2 = new ClanImage();
                ...
                case -37:
                {
                    ...
                    for (var num158 = 0; num158 < num157; num158++)
                    {
                        var num159 = msg.reader().readShort();
                        if (num159 == -1)
                            continue;
                        ...
                        if (num161 != 0)
                        {
                            ...
                            for (var num162 = 0;
                                 num162 < Char.myCharz().arrItemBody[num158].itemOption.Length;
                                 num162++)
                            {
                                int num163 = msg.reader().readUnsignedByte();
                                int param6 = msg.reader().readUnsignedShort();
                                if (num163 != -1)
                                    Char.myCharz().arrItemBody[num158].itemOption[num162] =
                                        new ItemOption(num163, param6);
                            }
                        }

                        if (num160 == 0)
                            Char.myCharz().body = Char.myCharz().arrItemBody[num158].template.part;
                        else if (num160 == 1) Char.myCharz().leg = Char.myCharz().arrItemBody[num158].template.part;
                    }
                ...
                case -36:
                {
                    ...
                    if (b38 == 0)
                    {
                        ...
                        for (var num102 = 0; num102 < num101; num102++)
                        {
                            var num103 = msg.reader().readShort();
                            if (num103 == -1)
                                continue;
                            ...
                            if (num104 != 0)
                            {
                                ...
                                for (var num105 = 0;
                                     num105 < Char.myCharz().arrItemBag[num102].itemOption.Length;
                                     num105++)
                                {
                                    int num106 = msg.reader().readUnsignedByte();
                                    int param5 = msg.reader().readUnsignedShort();
                                    if (num106 != -1)
                                        Char.myCharz().arrItemBag[num102].itemOption[num105] =
                                            new ItemOption(num106, param5);
                                }

                                Char.myCharz().arrItemBag[num102].compare =
                                    GameCanvas.panel.getCompare(Char.myCharz().arrItemBag[num102]);
                            }
                    ...
                    if (b38 == 2)
                    {
                        var b39 = msg.reader().readByte();
                        var num107 = msg.reader().readInt();
                        var quantity2 = Char.myCharz().arrItemBag[b39].quantity;
                        int id2 = Char.myCharz().arrItemBag[b39].template.id;
                        Char.myCharz().arrItemBag[b39].quantity = num107;
                        if (Char.myCharz().arrItemBag[b39].quantity < quantity2 &&
                            Char.myCharz().arrItemBag[b39].template.type == 6)
                        ...
                        else if (id2 == 193) GameScr.isudungCapsun3 = num107 > 0;
                    }
                ...
                case -35:
                {
                    ...
                    if (b32 == 0)
                    {
                        ...
                        for (var num80 = 0; num80 < num79; num80++)
                        {
                            var num81 = msg.reader().readShort();
                            if (num81 == -1)
                                continue;
                            ...
                            if (num82 != 0)
                            {
                                ...
                                for (var num83 = 0; num83 < Char.myCharz().arrItemBox[num80].itemOption.Length; num83++)
                                {
                                    int num84 = msg.reader().readUnsignedByte();
                                    int param4 = msg.reader().readUnsignedShort();
                                    if (num84 != -1)
                                        Char.myCharz().arrItemBox[num80].itemOption[num83] =
                                            new ItemOption(num84, param4);
                                }
                            }
                    ...
                    if (b32 == 2)
                    {
                        var b33 = msg.reader().readByte();
                        var quantity = msg.reader().readInt();
                ...
                case -45:
                {
                    var b48 = msg.reader().readByte();
                    var num136 = msg.reader().readInt();
                    var num137 = msg.reader().readShort();
                    Res.outz(">.SKILL_NOT_FOCUS      skillNotFocusID: " + num137 + " skill type= " + b48 +
                             "   player use= " + num136);
                    if (b48 == 20)
                    {
                        var b49 = msg.reader().readByte();
                        var dir = msg.reader().readByte();
                        var timeGong = msg.reader().readShort();
                        var isFly = msg.reader().readByte() != 0 ? true : false;
                        var typePaint = msg.reader().readByte();
                        sbyte typeItem = -1;
                        try
                        {
                    ...
                    if (b48 == 21)
                    {
                        ...
                        var timeDame = msg.reader().readShort();
                        var rangeDame = msg.reader().readShort();
                        sbyte typePaint2 = 0;
                        sbyte typeItem2 = -1;
                        Point[] array10 = null;
                        @char = Char.myCharz().charID != num136 ? GameScr.findCharInMap(num136) : Char.myCharz();
                        try
                        {
                            ...
                            var b50 = msg.reader().readByte();
                            if (b50 > 0)
                            {
                                array10 = new Point[b50];
                                for (var num138 = 0; num138 < array10.Length; num138++)
                                {
                        ...
                        Res.outz(">.SKILL_NOT_FOCUS  skill targetDame= " + point.x + ":" + point.y + "    c:" +
                                 @char.cx + ":" + @char.cy + "   cdir:" + @char.cdir);
                    ...
                    if (b48 == 0)
                    {
                        ...
                        var b51 = msg.reader().readByte();
                        Res.outz("npc size= " + b51);
                        for (var num139 = 0; num139 < b51; num139++)
                        {
                            var b52 = msg.reader().readByte();
                            var b53 = msg.reader().readByte();
                            Res.outz("index= " + b52);
                            if (num137 >= 42 && num137 <= 48)
                            {
                                ((Mob)GameScr.vMob.elementAt(b52)).isFreez = true;
                                ((Mob)GameScr.vMob.elementAt(b52)).seconds = b53;
                                ((Mob)GameScr.vMob.elementAt(b52)).last = ((Mob)GameScr.vMob.elementAt(b52)).cur =
                                    mSystem.currentTimeMillis();
                            }
                        }

                        var b54 = msg.reader().readByte();
                        for (var num140 = 0; num140 < b54; num140++)
                        {
                            var num141 = msg.reader().readInt();
                            var b55 = msg.reader().readByte();
                            ...
                            else
                            {
                                ...
                                if (@char != null && !@char.isFlyAndCharge && !@char.isStandAndCharge)
                                {
                                    ...
                                    @char.lastFreez = GameScr.findCharInMap(num141).currFreez =
                                        mSystem.currentTimeMillis();
                                }
                            }
                        }
                    ...
                    if (b48 == 4)
                    {
                        ...
                        {
                            var cgender = GameScr.findCharInMap(num136).cgender;
                            if (cgender == 0)
                            {
                ...
                case -44:
                {
                    ...
                    for (var num51 = 0; num51 < GameCanvas.panel.shopTabName.Length; num51++)
                    ...
                    for (var num52 = 0; num52 < num50; num52++)
                    {
                        var array7 = Res.split(msg.reader().readUTF(), "\n", 0);
                        if (b22 == 2)
                        ...
                        {
                            var num55 = msg.reader().readShort();
                            if (num55 == -1)
                                continue;
                            Char.myCharz().arrItemShop[num52][num54] = new Item();
                            Char.myCharz().arrItemShop[num52][num54].template = ItemTemplates.get(num55);
                            Res.outz("name " + num52 + " = " + Char.myCharz().arrItemShop[num52][num54].template.name +
                                     " id templat= " + Char.myCharz().arrItemShop[num52][num54].template.id);
                            if (b22 == 8)
                            {
                            ...
                            if (num56 != 0)
                            {
                                ...
                                for (var num57 = 0;
                                     num57 < Char.myCharz().arrItemShop[num52][num54].itemOption.Length;
                                     num57++)
                                {
                                    ...
                                    if (num58 != -1)
                                    {
                                        Char.myCharz().arrItemShop[num52][num54].itemOption[num57] =
                                            new ItemOption(num58, param2);
                                        Char.myCharz().arrItemShop[num52][num54].compare =
                                            GameCanvas.panel.getCompare(Char.myCharz().arrItemShop[num52][num54]);
                                    }
                                }
                            }

                            var b23 = msg.reader().readByte();
                            ...
                            if (msg.reader().readByte() == 1)
                            {
                                ...
                                Char.myCharz().arrItemShop[num52][num54]
                                    .setPartTemp(headTemp, bodyTemp, legTemp, bagTemp);
                            }
                    ...
                    if (b22 == 2)
                    {
                        var array8 = GameCanvas.panel.tabName[1];
                        if (flag6)
                ...
                case -41:
                {
                    var b20 = msg.reader().readByte();
                    Char.myCharz().strLevel = new string[b20];
                    for (var num44 = 0; num44 < b20; num44++)
                    {
                ...
                case -34:
                {
                    ...
                    if (b10 == 1)
                    {
                        ...
                        {
                            while (msg.reader().available() > 0)
                                myVector.addElement(new Command(msg.reader().readUTF(), GameCanvas.instance, 888392,
                                    null));
                        }
                        catch (Exception ex6)
                        {
                            Cout.println("Loi MAGIC_TREE " + ex6);
                        }
                ...
                case 11:
                {
                    ...
                    var array2 = NinjaUtil.readByteArray(msg);
                    var img = Image.createImage(array2, 0, array2.Length);
                ...
                case -66:
                {
                    var id3 = msg.reader().readShort();
                    var data4 = NinjaUtil.readByteArray(msg);
                    var effDataById = Effect.getEffDataById(id3);
                    var b62 = msg.reader().readSByte();
                    if (b62 == 0)
                        effDataById.readData(data4);
                    else
                        effDataById.readDataNewBoss(data4, b62);
                    var array16 = NinjaUtil.readByteArray(msg);
                    effDataById.img = Image.createImage(array16, 0, array16.Length);
                    break;
                }
                case -32:
                {
                    var num145 = msg.reader().readShort();
                    var num146 = msg.reader().readInt();
                    sbyte[] array14 = null;
                    Image image = null;
                    try
                    {
                        array14 = new sbyte[num146];
                        for (var num147 = 0; num147 < num146; num147++) array14[num147] = msg.reader().readByte();
                ...
                case 92:
                {
                    if (GameCanvas.currentScreen == GameScr.instance)
                        GameCanvas.endDlg();
                    var text3 = msg.reader().readUTF();
                    var text4 = Res.changeString(msg.reader().readUTF());
                ...
                {
                    GameCanvas.debug("SXX5", 2);
                    var mob4 = (Mob)GameScr.vMob.elementAt(msg.reader().readUnsignedByte());
                ...
                case 56:
                {
                    ...
                    @char = null;
                    var num13 = msg.reader().readInt();
                    if (num13 == Char.myCharz().charID)
                    {
                        var flag4 = false;
                        @char = Char.myCharz();
                        @char.cHP = msg.readInt3Byte();
                        var num21 = msg.readInt3Byte();
                        ...
                        {
                            if (num21 == 0)
                                GameScr.startFlyText(mResources.miss, @char.cx, @char.cy - @char.ch, 0, -3,
                                    mFont.MISS_ME);
                            else
                                GameScr.startFlyText("-" + num21, @char.cx, @char.cy - @char.ch, 0, -3,
                                    flag4 ? mFont.FATAL : mFont.RED);
                        }
                    ...
                    if (@char.cTypePk != 4)
                    {
                        if (num23 == 0)
                            ...
                            GameScr.startFlyText("-" + num23, @char.cx, @char.cy - @char.ch, 0, -3,
                                flag5 ? mFont.FATAL : mFont.ORANGE);
                    }
                ...
                case 83:
                {
                    ...
                    if (@char == null)
                        return;
                    var mobToAttack = (Mob)GameScr.vMob.elementAt(msg.reader().readUnsignedByte());
                    if (@char.mobMe != null)
                ...
                case 64:
                    ...
                    {
                        Cout.println("Loi CLEAR_CUU_SAT " + ex2);
                    }
                ...
                case 58:
                {
                    ...
                    var num13 = msg.reader().readInt();
                    var char4 = num13 != Char.myCharz().charID ? GameScr.findCharInMap(num13) : Char.myCharz();
                    char4.moveFast = new short[3];
                    char4.moveFast[0] = 0;
                    var num14 = msg.reader().readShort();
                    var num15 = msg.reader().readShort();
                    char4.moveFast[1] = num14;
                    char4.moveFast[2] = num15;
                    try
                    {
                        num13 = msg.reader().readInt();
                        var char5 = num13 != Char.myCharz().charID ? GameScr.findCharInMap(num13) : Char.myCharz();
                        char5.cx = num14;
                        char5.cy = num15;
                    }
                    catch (Exception ex3)
                    {
                        Cout.println("Loi MOVE_FAST " + ex3);
                    }
                ...
                case 88:
                {
                    var info4 = msg.reader().readUTF();
                    var num174 = msg.reader().readShort();
                    GameCanvas.inputDlg.show(info4, new Command(mResources.ACCEPT, GameCanvas.instance, 88818, num174),
                ...
                {
                    myVector = new MyVector();
                    var text10 = msg.reader().readUTF();
                    int num166 = msg.reader().readByte();
                    for (var num167 = 0; num167 < num166; num167++)
                    {
                        var caption2 = msg.reader().readUTF();
                        var num168 = msg.reader().readShort();
                ...
                case 33:
                {
                    ...
                    {
                        Cout.println("Loi OPEN_UI_MENU " + ex25);
                    }

                    if (Char.myCharz().npcFocus == null)
                        return;
                    for (var num156 = 0; num156 < Char.myCharz().npcFocus.template.menu.Length; num156++)
                    {
                        var array15 = Char.myCharz().npcFocus.template.menu[num156];
                ...
                case 40:
                {
                    ...
                    var taskId = msg.reader().readShort();
                    var index3 = msg.reader().readByte();
                    var name2 = Res.changeString(msg.reader().readUTF());
                    var detail = Res.changeString(msg.reader().readUTF());
                    var array11 = new string[msg.reader().readByte()];
                    var array12 = new string[array11.Length];
                    GameScr.tasks = new int[array11.Length];
                    GameScr.mapTasks = new int[array11.Length];
                    var array13 = new short[array11.Length];
                    short count = -1;
                    for (var num143 = 0; num143 < array11.Length; num143++)
                    {
                        var text8 = Res.changeString(msg.reader().readUTF());
                        GameScr.tasks[num143] = msg.reader().readByte();
                        GameScr.mapTasks[num143] = msg.reader().readShort();
                        var text9 = Res.changeString(msg.reader().readUTF());
                        array13[num143] = -1;
                    ...
                    try
                    {
                        ...
                        for (var num144 = 0; num144 < array11.Length; num144++)
                    ...
                    Char.myCharz().taskMaint =
                        new Task(taskId, index3, name2, detail, array11, array13, count, array12);
                    if (Char.myCharz().npcFocus != null)
                        Npc.clearEffTask();
                ...
                case 50:
                {
                    var b56 = msg.reader().readByte();
                    Panel.vGameInfo.removeAllElements();
                    for (var num142 = 0; num142 < b56; num142++)
                    {
                ...
                case 43:
                    ...
                    try
                    {
                        var x_hint = msg.reader().readShort();
                        var y_hint = msg.reader().readShort();
                ...
                case -21:
                {
                    ...
                    for (var num135 = 0; num135 < GameScr.vItemMap.size(); num135++)
                ...
                case -20:
                {
                    ...
                    Char.myCharz().itemFocus = null;
                    var itemMapID = msg.reader().readShort();
                    for (var num131 = 0; num131 < GameScr.vItemMap.size(); num131++)
                    {
                        var itemMap3 = (ItemMap)GameScr.vItemMap.elementAt(num131);
                        if (itemMap3.itemMapID != itemMapID)
                            continue;
                        itemMap3.setPoint(Char.myCharz().cx, Char.myCharz().cy - 10);
                        var text7 = msg.reader().readUTF();
                        num = 0;
                        try
                        {
                        ...
                        if (text7.Equals(string.Empty))
                        {
                            if (itemMap3.template.type == 9)
                            {
                                GameScr.startFlyText((num >= 0 ? "+" : string.Empty) + num, Char.myCharz().cx,
                                    Char.myCharz().cy - Char.myCharz().ch, 0, -2, mFont.YELLOW);
                                SoundMn.gI().getItem();
                            }
                            else if (itemMap3.template.type == 10)
                            {
                                GameScr.startFlyText((num >= 0 ? "+" : string.Empty) + num, Char.myCharz().cx,
                                    Char.myCharz().cy - Char.myCharz().ch, 0, -2, mFont.GREEN);
                                SoundMn.gI().getItem();
                            }
                            else if (itemMap3.template.type == 34)
                            {
                                GameScr.startFlyText((num >= 0 ? "+" : string.Empty) + num, Char.myCharz().cx,
                                    Char.myCharz().cy - Char.myCharz().ch, 0, -2, mFont.RED);
                                SoundMn.gI().getItem();
                            }
                            else
                            {
                                GameScr.info1.addInfo(
                                    mResources.you_receive + " " + (num <= 0 ? string.Empty : num + " ") +
                                    itemMap3.template.name, 0);
                                SoundMn.gI().getItem();
                            }

                            if (num > 0 && Char.myCharz().petFollow != null && Char.myCharz().petFollow.smallID == 4683)
                            {
                                ServerEffect.addServerEffect(55, Char.myCharz().petFollow.cmx,
                                    Char.myCharz().petFollow.cmy, 1);
                ...
                case -19:
                {
                    ...
                    var itemMapID = msg.reader().readShort();
                    @char = GameScr.findCharInMap(msg.reader().readInt());
                    for (var num130 = 0; num130 < GameScr.vItemMap.size(); num130++)
                    {
                        var itemMap2 = (ItemMap)GameScr.vItemMap.elementAt(num130);
                        ...
                        if (itemMap2.x < @char.cx)
                            @char.cdir = -1;
                        else if (itemMap2.x > @char.cx) @char.cdir = 1;
                        break;
                    }
                ...
                case -18:
                {
                    ...
                    GameScr.vItemMap.addElement(new ItemMap(msg.reader().readShort(),
                        Char.myCharz().arrItemBag[num129].template.id, Char.myCharz().cx, Char.myCharz().cy,
                ...
                case 68:
                {
                    ...
                    var num99 = msg.reader().readInt();
                    short r = 0;
                    if (num99 == -2)
                        r = msg.reader().readShort();
                    var itemMap = new ItemMap(num99, itemMapID, itemTemplateID, x, y, r);
                    var flag8 = false;
                    for (var num100 = 0; num100 < GameScr.vItemMap.size(); num100++)
                ...
                case -14:
                    ...
                    if (@char == null)
                        return;
                    GameScr.vItemMap.addElement(new ItemMap(msg.reader().readShort(), msg.reader().readShort(),
                        @char.cx, @char.cy, msg.reader().readShort(), msg.reader().readShort()));
                    break;
                case -22:
                ...
                case -70:
                {
                    ...
                    var chat4 = msg.reader().readUTF();
                    var npc5 = new Npc(-1, 0, 0, 0, 0, 0);
                    npc5.avatar = avatar;
                    ChatPopup.addBigMessage(chat4, 100000, npc5);
                    var b36 = msg.reader().readByte();
                    if (b36 == 0)
                    {
                        ChatPopup.serverChatPopUp.cmdMsg1 =
                            new Command(mResources.CLOSE, ChatPopup.serverChatPopUp, 1001, null);
                    ...
                    if (b36 == 1)
                    {
                        var p = msg.reader().readUTF();
                        var caption = msg.reader().readUTF();
                        ...
                        ChatPopup.serverChatPopUp.cmdMsg1.y = GameCanvas.h - 35;
                        ChatPopup.serverChatPopUp.cmdMsg2 =
                            new Command(mResources.CLOSE, ChatPopup.serverChatPopUp, 1001, null);
                ...
                case 38:
                {
                    ...
                    var chat3 = Res.changeString(msg.reader().readUTF());
                    for (var num93 = 0; num93 < GameScr.vNpc.size(); num93++)
                    {
                        var npc3 = (Npc)GameScr.vNpc.elementAt(num93);
                    ...
                    var npc4 = new Npc(num46, 0, 0, 0, num46, GameScr.info1.charId[Char.myCharz().cgender][2]);
                ...
                case 32:
                {
                    ...
                    int num46 = msg.reader().readShort();
                    for (var num47 = 0; num47 < GameScr.vNpc.size(); num47++)
                    {
                        var npc = (Npc)GameScr.vNpc.elementAt(num47);
                        if (npc.template.npcTemplateId == num46 && npc.Equals(Char.myCharz().npcFocus))
                        {
                            var chat = msg.reader().readUTF();
                            var array5 = new string[msg.reader().readByte()];
                            for (var num48 = 0; num48 < array5.Length; num48++) array5[num48] = msg.reader().readUTF();
                    ...
                    var npc2 = new Npc(num46, 0, -100, 100, num46, GameScr.info1.charId[Char.myCharz().cgender][2]);
                    Res.outz(Char.myCharz().npcFocus == null ? "null" : "!null");
                    var chat2 = msg.reader().readUTF();
                    var array6 = new string[msg.reader().readByte()];
                    for (var num49 = 0; num49 < array6.Length; num49++) array6[num49] = msg.reader().readUTF();
                    try
                    {
                ...
                case 7:
                {
                    ...
                    var id = msg.reader().readShort();
                    var info2 = msg.reader().readUTF();
                ...
                case -4:
                {
                    ...
                    for (var k = 0; k < @char.attMobs.Length; k++)
                    {
                        var mob3 = (Mob)GameScr.vMob.elementAt(msg.reader().readByte());
                        @char.attMobs[k] = mob3;
                        if (k == 0)
                        {
                            if (@char.cx <= mob3.x)
                    ...
                    try
                    {
                        ...
                        {
                            var num13 = msg.reader().readInt();
                            var char7 = array[num] = num13 != Char.myCharz().charID
                                ? GameScr.findCharInMap(num13)
                                : Char.myCharz();
                            if (num == 0)
                            {
                                if (@char.cx <= char7.cx)
                    ...
                    {
                        Cout.println("Loi PLAYER_ATTACK_N_P " + ex5);
                    }
                    ...
                    if (num > 0)
                    {
                        ...
                        for (num = 0; num < @char.attChars.Length; num++) @char.attChars[num] = array[num];
                ...
                case 54:
                {
                    ...
                    var array3 = new Mob[10];
                    num = 0;
                    try
                    {
                        for (num = 0; num < array3.Length; num++)
                        {
                            var mob2 = array3[num] = (Mob)GameScr.vMob.elementAt(msg.reader().readByte());
                            if (num == 0)
                            {
                                if (@char.cx <= mob2.x)
                                    @char.cdir = 1;
                    ...
                    if (num > 0)
                    {
                        ...
                        for (num = 0; num < @char.attMobs.Length; num++) @char.attMobs[num] = array3[num];
                        @char.charFocus = null;
                        @char.mobFocus = @char.attMobs[0];
                    }
                ...
                case -60:
                {
                    ...
                    {
                        var char2 = GameScr.findCharInMap(num2);
                        if (char2 == null)
                            return;
                        ...
                        var array = new Char[msg.reader().readByte()];
                        for (num = 0; num < array.Length; num++)
                        {
                        ...
                        if (num > 0)
                        {
                            ...
                            for (num = 0; num < char2.attChars.Length; num++) char2.attChars[num] = array[num];
                            char2.mobFocus = null;
            ...
            switch (command2)
            {
                default:
                    switch (command2)
                    {
                        default:
                            switch (command2)
                            {
                                default:
                                {
                                    if (command2 != 18)
                                    {
                                        if (command2 != 19)
                                        {
                                            if (command2 != 44)
                                            {
                                                if (command2 != 45)
                                                {
                                                    if (command2 != 66)
                                                    {
                                                        ...
                                                        try
                                                        {
                                                            mob9 = (Mob)GameScr.vMob.elementAt(msg.reader()
                                                                .readUnsignedByte());
                                                        }
                                                        catch (Exception)
                                                        {
                                                        ...
                                                        if (mob9 != null && mob9.status != 0 && mob9.status != 0)
                                                        {
                                                            ...
                                                            var itemMap4 = new ItemMap(msg.reader().readShort(),
                                                                msg.reader().readShort(), mob9.x, mob9.y,
                                                                msg.reader().readShort(), msg.reader().readShort());
                                                            GameScr.vItemMap.addElement(itemMap4);
                                                            if (Res.abs(itemMap4.y - Char.myCharz().cy) < 24 &&
                                                                Res.abs(itemMap4.x - Char.myCharz().cx) < 24)
                                                                Char.myCharz().charFocus = null;
                                                        }
                                                    }
                                                    else
                                                    {
                                                        Res.outz(
                                                            "ME DIE XP DOWN NOT IMPLEMENT YET!!!!!!!!!!!!!!!!!!!!!!!!!!");
                                                    }
                                                }
                                                else
                                                {
                                                    ...
                                                    {
                                                        Cout.println("Loi tai NPC_MISS  " + ex36);
                                                    }
                                                    ...
                                                    if (mob9 != null)
                                                    {
                                                        ...
                                                        mob9.updateHp_bar();
                                                        GameScr.startFlyText(mResources.miss, mob9.x, mob9.y - mob9.h,
                                                            0, -2, mFont.MISS);
                                                    }
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                var num184 = msg.reader().readInt();
                                                var text11 = msg.reader().readUTF();
                                                Res.outz("user id= " + num184 + " text= " + text11);
                                                @char = Char.myCharz().charID != num184
                                                    ? GameScr.findCharInMap(num184)
                                                    : Char.myCharz();
                                                if (@char == null)
                                                    return;
                                                @char.addInfo(text11);
                                    ...
                                    var b66 = msg.reader().readByte();
                                    for (var num185 = 0; num185 < b66; num185++)
                                    {
                                        var charId = msg.reader().readInt();
                                        int cx = msg.reader().readShort();
                                        int cy = msg.reader().readShort();
                                        var cHPShow = msg.readInt3Byte();
                                        var char13 = GameScr.findCharInMap(charId);
                                        if (char13 != null)
                                        {
                                            char13.cx = cx;
                                            char13.cy = cy;
                                ...
                                case -73:
                                {
                                    ...
                                    for (var num186 = 0; num186 < GameScr.vNpc.size(); num186++)
                                    {
                                        var npc7 = (Npc)GameScr.vNpc.elementAt(num186);
                        ...
                        case 95:
                        {
                            ...
                            var num187 = msg.reader().readInt();
                            Char.myCharz().xu += num187;
                            Char.myCharz().xuStr = Res.formatNumber(Char.myCharz().xu);
                            GameScr.startFlyText(num187 <= 0 ? string.Empty + num187 : "+" + num187, Char.myCharz().cx,
                                Char.myCharz().cy - Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
                            break;
                        }
                        case 96:
                            GameCanvas.debug("SA77a", 22);
                            Char.myCharz().taskOrders.addElement(new TaskOrder(msg.reader().readByte(),
                                msg.reader().readShort(), msg.reader().readShort(), msg.reader().readUTF(),
                                msg.reader().readUTF(), msg.reader().readByte(), msg.reader().readByte()));
                            break;
                        case 97:
                        {
                            var b65 = msg.reader().readByte();
                            for (var num183 = 0; num183 < Char.myCharz().taskOrders.size(); num183++)
                            {
                                var taskOrder = (TaskOrder)Char.myCharz().taskOrders.elementAt(num183);
                ...
                {
                    GameCanvas.debug("SA77", 22);
                    var num197 = msg.reader().readInt();
                    Char.myCharz().yen += num197;
                    GameScr.startFlyText(num197 <= 0 ? string.Empty + num197 : "+" + num197, Char.myCharz().cx,
                        Char.myCharz().cy - Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
                    break;
                }
                case -1:
                {
                    ...
                    var num179 = msg.reader().readInt();
                    Char.myCharz().xu += num179;
                    Char.myCharz().xuStr = Res.formatNumber(Char.myCharz().xu);
                    Char.myCharz().yen -= num179;
                    GameScr.startFlyText("+" + num179, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 10, 0,
                        -2, mFont.YELLOW);
                    break;
                }
                case -3:
                {
                    ...
                    var b71 = msg.reader().readByte();
                    var num196 = msg.reader().readInt();
                    if (b71 == 0)
                    ...
                    {
                        GameScr.startFlyText((num196 <= 0 ? string.Empty : "+") + num196, Char.myCharz().cx,
                            Char.myCharz().cy - Char.myCharz().ch, 0, -4, mFont.GREEN);
                        if (num196 > 0 && Char.myCharz().petFollow != null && Char.myCharz().petFollow.smallID == 5002)
                        {
                            ServerEffect.addServerEffect(55, Char.myCharz().petFollow.cmx, Char.myCharz().petFollow.cmy,
                                1);
                            ServerEffect.addServerEffect(55, Char.myCharz().cx, Char.myCharz().cy, 1);
                        }
                    }
                ...
                case -5:
                {
                    ...
                    if (readCharInfo(char14, msg))
                    {
                        ...
                        if (char14.cy <= 10 && b68 != 0 && b68 != 2)
                        {
                            ...
                            var teleport2 = new Teleport(char14.cx, char14.cy, char14.head, char14.cdir, 1, false,
                                b68 != 1 ? b68 : char14.cgender);
                        ...
                        if (b68 == 2)
                            char14.show();
                        for (var num189 = 0; num189 < GameScr.vMob.size(); num189++)
                        {
                            var mob10 = (Mob)GameScr.vMob.elementAt(num189);
                        ...
                        var num190 = msg.reader().readShort();
                        ...
                        if (num190 != -1)
                        {
                            ...
                            else if (num190 >= Char.ID_NEW_MOUNT) char14.idMount = num190;
                        }
                        else
                        {
                    ...
                    try
                    {
                        ...
                        {
                            var effect3 = new Effect(char14.bag, char14, 2, -1, 10, 1);
                            effect3.typeEff = 5;
                            char14.addEffChar(effect3);
                        }
                        else
                        {
                            for (var num191 = 0; num191 < 54; num191++) char14.removeEffChar(0, 201 + num191);
                        }
                    }
                ...
                case -7:
                {
                    ...
                    var num180 = msg.reader().readInt();
                    for (var num195 = 0; num195 < GameScr.vCharInMap.size(); num195++)
                    {
                        Char char15 = null;
                        try
                        {
                ...
                case -6:
                {
                    ...
                    var num180 = msg.reader().readInt();
                    for (var num181 = 0; num181 < GameScr.vCharInMap.size(); num181++)
                    {
                        var char12 = (Char)GameScr.vCharInMap.elementAt(num181);
                ...
                case -13:
                {
                    ...
                    if (num178 > GameScr.vMob.size() - 1 || num178 < 0)
                        return;
                    var mob9 = (Mob)GameScr.vMob.elementAt(num178);
                ...
                case -12:
                {
                    ...
                    try
                    {
                        ...
                        var b70 = msg.reader().readByte();
                        for (var num193 = 0; num193 < b70; num193++)
                        {
                            var itemMap5 = new ItemMap(msg.reader().readShort(), msg.reader().readShort(), mob9.x,
                                mob9.y, msg.reader().readShort(), msg.reader().readShort());
                            var num194 = itemMap5.playerId = msg.reader().readInt();
                            Res.outz("playerid= " + num194 + " my id= " + Char.myCharz().charID);
                            GameScr.vItemMap.addElement(itemMap5);
                            if (Res.abs(itemMap5.y - Char.myCharz().cy) < 24 &&
                                Res.abs(itemMap5.x - Char.myCharz().cx) < 24)
                                Char.myCharz().charFocus = null;
                        }
                    }
                    catch (Exception)
    ...
    public void requestItemPlayer(Message msg)
    {
        try
        {
            ...
            var item = GameScr.currentCharViewInfo.arrItemBody[num];
            ...
            {
                while (true)
                    item.options.addElement(new ItemOption(msg.reader().readUnsignedByte(),
    ...
    internal void readLogin(Message msg)
    {
        ...
        for (var i = 0; i < b; i++)
        {
            var playerID = msg.reader().readInt();
            var name = msg.reader().readUTF();
            var head = msg.reader().readShort();
            var body = msg.reader().readShort();
            var leg = msg.reader().readShort();
            var ppoint = msg.reader().readLong();
    ...
    internal void createItem(myReader d)
    {
        ...
        for (var i = 0; i < GameScr.gI().iOptionTemplates.Length; i++)
        {
        ...
        int num = d.readShort();
        for (var j = 0; j < num; j++)
            ItemTemplates.add(new ItemTemplate((short)j, d.readByte(), d.readByte(), d.readUTF(), d.readUTF(),
                d.readByte(), d.readInt(), d.readShort(), d.readShort(), d.readBool()));
    }
    ...
    internal void createSkill(myReader d)
    {
        ...
        for (var i = 0; i < GameScr.gI().sOptionTemplates.Length; i++)
        {
        ...
        for (var j = 0; j < GameScr.nClasss.Length; j++)
        {
            GameScr.nClasss[j] = new NClass();
            GameScr.nClasss[j].classId = j;
            GameScr.nClasss[j].name = d.readUTF();
            GameScr.nClasss[j].skillTemplates = new SkillTemplate[d.readByte()];
            for (var k = 0; k < GameScr.nClasss[j].skillTemplates.Length; k++)
            {
                ...
                if (GameCanvas.w == 128 || GameCanvas.h <= 208)
                    lineWidth = 100;
                GameScr.nClasss[j].skillTemplates[k].description =
                    mFont.tahoma_7_green2.splitFontArray(d.readUTF(), lineWidth);
                GameScr.nClasss[j].skillTemplates[k].skills = new Skill[d.readByte()];
                for (var l = 0; l < GameScr.nClasss[j].skillTemplates[k].skills.Length; l++)
                {
    ...
    internal void createMap(myReader d)
    {
        ...
        for (var i = 0; i < TileMap.mapNames.Length; i++) TileMap.mapNames[i] = d.readUTF();
        ...
        for (sbyte b = 0; b < Npc.arrNpcTemplate.Length; b++)
        {
            ...
            for (var j = 0; j < Npc.arrNpcTemplate[b].menu.Length; j++)
            {
                Npc.arrNpcTemplate[b].menu[j] = new string[d.readByte()];
                for (var k = 0; k < Npc.arrNpcTemplate[b].menu[j].Length; k++)
    ...
    public void loadCurrMap(sbyte teleport3)
    {
        ...
        for (var i = 0; i < Char.myCharz().vEff.size(); i++)
        ...
        {
            Teleport.addTeleport(new Teleport(Char.myCharz().cx, Char.myCharz().cy, Char.myCharz().head,
                Char.myCharz().cdir, 1, true, teleport3 != 1 ? teleport3 : Char.myCharz().cgender));
    ...
    public void loadInfoMap(Message msg)
    {
        try
        {
            ...
            Res.outz("head= " + Char.myCharz().head + " body= " + Char.myCharz().body + " left= " + Char.myCharz().leg +
                     " x= " + Char.myCharz().cx + " y= " + Char.myCharz().cy + " chung toc= " + Char.myCharz().cgender);
            ...
            for (var i = 0; i < num; i++)
            {
                var waypoint = new Waypoint(msg.reader().readShort(), msg.reader().readShort(),
                    msg.reader().readShort(), msg.reader().readShort(), msg.reader().readBoolean(),
                    msg.reader().readBoolean(), msg.reader().readUTF());
            ...
            {
                var mob = new Mob(b, msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readBoolean(),
                    msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readByte(),
            ...
            {
                var b3 = msg.reader().readByte();
                var cx = msg.reader().readShort();
                var num2 = msg.reader().readShort();
                var b4 = msg.reader().readByte();
                var num3 = msg.reader().readShort();
                if (b4 != 6 &&
                    ((Char.myCharz().taskMaint.taskId >= 7 &&
                      (Char.myCharz().taskMaint.taskId != 7 || Char.myCharz().taskMaint.index > 1)) ||
                     (b4 != 7 && b4 != 8 && b4 != 9)) && (Char.myCharz().taskMaint.taskId >= 6 || b4 != 16))
                {
                    if (b4 == 4)
                    {
                    ...
                    {
                        var o = new Npc(j, b3, cx, num2 + 3, b4, num3);
            ...
            for (var k = 0; k < num; k++)
            {
                ...
                var flag = false;
                for (var l = 0; l < GameScr.vItemMap.size(); l++)
            ...
            if (!GameCanvas.lowGraphic || (GameCanvas.lowGraphic && TileMap.isVoDaiMap()) || TileMap.mapID == 45 ||
                TileMap.mapID == 46 || TileMap.mapID == 47 || TileMap.mapID == 48 || TileMap.mapID == 120 ||
                TileMap.mapID == 128 || TileMap.mapID == 170 || TileMap.mapID == 49)
            {
                var num6 = msg.reader().readShort();
                empty = "item high graphic: ";
                for (var m = 0; m < num6; m++)
                {
                    var num7 = msg.reader().readShort();
                    var num8 = msg.reader().readShort();
                    var num9 = msg.reader().readShort();
                    if (TileMap.getBIById(num7) != null)
                    {
                        var bIById = TileMap.getBIById(num7);
                        var bgItem = new BgItem();
                        bgItem.id = num7;
                        ...
                        if (!BgItem.imgNew.containsKey(bgItem.idImage + string.Empty))
                        {
                            ...
                            {
                                var flag2 = false;
                                var array = Rms.loadRMS(mGraphics.zoomLevel + "bgItem" + bgItem.idImage);
                                if (array != null)
                                {
                                    if (BgItem.newSmallVersion != null)
                                    {
                                        Res.outz("Small  last= " + array.Length % 127 + "new Version= " +
                                                 BgItem.newSmallVersion[bgItem.idImage]);
                ...
                for (var n = 0; n < BgItem.vKeysLast.size(); n++)
                {
                    var text = (string)BgItem.vKeysLast.elementAt(n);
                ...
                var num10 = msg.reader().readShort();
            ...
            else
            {
                ...
                var num17 = msg.reader().readShort();
    ...
    public void keyValueAction(string key, string value)
    {
        if (key.Equals("eff"))
        {
            if (Panel.graphics > 0)
                return;
            var array = Res.split(value, ".", 0);
            var id = int.Parse(array[0]);
            var layer = int.Parse(array[1]);
            var x = int.Parse(array[2]);
            ...
            var effect = new Effect(id, x, y, layer, loop, loopCount);
            if (array.Length > 6)
            {
        ...
        try
        {
            ...
            switch (b)
            {
                ...
                case 18:
                {
                    ...
                    GameCanvas.endDlg();
                    var num2 = msg.reader().readInt();
                    GameCanvas.inputDlg.show(mResources.changeNameChar,
                        new Command(mResources.OK, GameCanvas.instance, 88829, num2), TField.INPUT_TYPE_ANY);
                    break;
                }
                case 20:
                    Char.myCharz().cPk = msg.reader().readByte();
                ...
                case 4:
                {
                    ...
                    for (var j = 0; j < GameScr.exps.Length; j++) GameScr.exps[j] = msg.reader().readLong();
                    break;
                }
                case 6:
                {
                ...
                case 7:
                {
                    ...
                    msg.reader().reset();
                    var data = new sbyte[msg.reader().available()];
                ...
                case 10:
                    try
                    {
                        ...
                        for (var i = 0; i < TileMap.maps.Length; i++)
                        {
                            int num = msg.reader().readByte();
                            if (num < 0)
                                num += 256;
        ...
        try
        {
            ...
            switch (b)
            {
                ...
                case 2:
                {
                    ...
                    Char.myCharz().vSkillFight.removeAllElements();
                    var b3 = msg.reader().readByte();
                    for (sbyte b6 = 0; b6 < b3; b6++) useSkill(Skills.get(msg.reader().readShort()));
                ...
                case 0:
                {
                    ...
                    GameScr.gI().dMP = Char.myCharz().cMP;
                    var b3 = msg.reader().readByte();
                    for (sbyte b4 = 0; b4 < b3; b4++) useSkill(Skills.get(msg.reader().readShort()));
                    GameScr.gI().sortSkill();
                    ...
                    {
                        Char.myCharz().setDefaultPart();
                        for (var j = 0; j < Char.myCharz().arrItemBody.Length; j++)
                        {
                            var num3 = msg.reader().readShort();
                            if (num3 == -1)
                                continue;
                            var itemTemplate = ItemTemplates.get(num3);
                            ...
                            if (num5 != 0)
                            {
                                ...
                                for (var k = 0; k < Char.myCharz().arrItemBody[j].itemOption.Length; k++)
                                {
                    ...
                    GameScr.isudungCapsun4 = false;
                    GameScr.isudungCapsun3 = false;
                    for (var l = 0; l < Char.myCharz().arrItemBag.Length; l++)
                    {
                        var num7 = msg.reader().readShort();
                        if (num7 == -1)
                            continue;
                        ...
                        if (b5 != 0)
                        {
                            ...
                            for (var m = 0; m < Char.myCharz().arrItemBag[l].itemOption.Length; m++)
                            {
                    ...
                    GameCanvas.panel.hasUse = 0;
                    for (var n = 0; n < Char.myCharz().arrItemBox.Length; n++)
                    {
                        var num9 = msg.reader().readShort();
                        if (num9 == -1)
                            continue;
                        ...
                        for (var num10 = 0; num10 < Char.myCharz().arrItemBox[n].itemOption.Length; num10++)
                        {
                    ...
                    for (var num14 = 0; num14 < GameScr.info1.charId.Length; num14++)
                ...
                case 7:
                {
                    var @char = GameScr.findCharInMap(msg.reader().readInt());
                    if (@char == null)
                        return;
                ...
                case 13:
                {
                    ...
                    var num15 = msg.reader().readInt();
                    var @char = num15 != Char.myCharz().charID ? GameScr.findCharInMap(num15) : Char.myCharz();
                    if (@char != null)
                    {
                        @char.cHP = msg.readInt3Byte();
                        @char.cHPFull = msg.readInt3Byte();
                ...
                case 35:
                {
                    ...
                    {
                        var @char = GameScr.findCharInMap(num2);
                        if (@char != null)
                        {
                    ...
                    {
                        var char2 = GameScr.findCharInMap(i);
                ...
                case 23:
                {
                    var num = msg.reader().readShort();
                    var skill = Skills.get(num);
                    useSkill(skill);
            ...
            switch (b)
            {
                case 63:
                {
                    ...
                    if (b7 > 0)
                    {
                        ...
                        for (var num17 = 0; num17 < b7; num17++)
                        {
                            var caption = msg.reader().readUTF();
                            var caption2 = msg.reader().readUTF();
                            var num18 = msg.reader().readShort();
                            GameCanvas.panel.vPlayerMenu_id.addElement(num18 + string.Empty);
                            Char.myCharz().charFocus.menuSelect = num18;
                            var command = new Command(caption, 11115, Char.myCharz().charFocus);
                ...
                {
                    var text = msg.reader().readUTF();
                    var data = new sbyte[msg.reader().readInt()];
                    ...
                    else if (text.Equals("CSkill")) GameScr.gI().onCSkill(data);
                    break;
                }
                case 62:
    ...
    internal void useSkill(Skill skill)
    {
        ...
        else if (skill.template.Equals(Char.myCharz().myskill.template)) Char.myCharz().myskill = skill;
        Char.myCharz().vSkill.addElement(skill);
        if ((skill.template.type == 1 || skill.template.type == 4 || skill.template.type == 2 ||
             skill.template.type == 3) &&
    ...
    public bool readCharInfo(Char c, Message msg)
    {
        try
        {
            ...
            for (var i = 0; i < num; i++)
            {
                var effectChar = new EffectChar(msg.reader().readByte(), msg.reader().readInt(), msg.reader().readInt(),
    ...
    internal void readGetImgByName(Message msg)
    {
        ...
        {
            var name = msg.reader().readUTF();
            var nFrame = msg.reader().readByte();
            sbyte[] array = null;
    ...
    internal void loadItemNew(myReader d, sbyte type, bool isSave)
    {
        try
        {
            ...
            if (type == 0)
            {
                ...
                {
                    d.reset();
                    var data = new sbyte[d.available()];
            ...
            else if (type == 1)
            {
                ...
                for (var j = 0; j < num; j++)
                    ItemTemplates.add(new ItemTemplate((short)j, d.readByte(), d.readByte(), d.readUTF(), d.readUTF(),
                        d.readByte(), d.readInt(), d.readShort(), d.readShort(), d.readBoolean()));
                if (isSave)
                {
                    d.reset();
                    var data2 = new sbyte[d.available()];
            ...
            else if (type == 2)
            {
                ...
                for (var k = num2; k < num3; k++)
                    ItemTemplates.add(new ItemTemplate((short)k, d.readByte(), d.readByte(), d.readUTF(), d.readUTF(),
                        d.readByte(), d.readInt(), d.readShort(), d.readShort(), d.readBoolean()));
                if (isSave)
                {
                    d.reset();
                    var data3 = new sbyte[d.available()];
            ...
            else if (type == 100)
            {
                ...
                {
                    d.reset();
                    var data4 = new sbyte[d.available()];
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        d.reset();
                        var data5 = new sbyte[d.available()];
    ...
    internal void readFrameBoss(Message msg, int mobTemplateId)
    {
        try
        {
            ...
            for (var i = 0; i < num; i++)
            {
                ...
                for (var j = 0; j < num2; j++) array[i][j] = msg.reader().readByte();
            }
    ...
    {
        var array = new int[1][] { new int[2] { 542, 543 } };
        try
        {
            ...
            for (var i = 0; i < array.Length; i++)
            {
                int num = d.readByte();
                array[i] = new int[num];
                for (var j = 0; j < num; j++) array[i][j] = d.readShort();
            }
        }
        catch (Exception)
        {
    ...
    internal void readPhuBan_CHIENTRUONGNAMEK(Message msg, int type_PB)
    {
        try
        {
            ...
            if (b == 0)
            {
                var idmapPaint = msg.reader().readShort();
                var nameTeam = msg.reader().readUTF();
                var nameTeam2 = msg.reader().readUTF();
                var maxPoint = msg.reader().readInt();
                var timeSecond = msg.reader().readShort();
            ...
            {
                var pointTeam = msg.reader().readInt();
                var pointTeam2 = msg.reader().readInt();
            ...
            {
                var timeSecond2 = msg.reader().readShort();
                if (GameScr.phuban_Info != null)
    ...
    public void read_opt(Message msg)
    {
        try
        {
            ...
            if (b == 0)
            {
                var idHat = msg.reader().readShort();
                Char.myCharz().idHat = idHat;
                SoundMn.gI().getStrOption();
            }
            else if (b == 2)
            {
                var num = msg.reader().readInt();
                var b2 = msg.reader().readByte();
                var num2 = msg.reader().readShort();
                var v = num2 + "," + b2;
                var imagePath = ImgByName.getImagePath("banner_" + num2, ImgByName.hashImagePath);
            ...
            else
            {
                ...
                if (b3 == 0)
                {
                    ...
                    var text2 = text;
                    text = text2 + "\tsub    0|  nCT_team= " + GameScr.nCT_team + "|nCT_TeamA =" + GameScr.nCT_TeamA +
                           "  isPaint_CT=false \n";
                }
                else if (b3 == 1)
                {
                    var num4 = msg.reader().readInt();
                    var b4 = GameScr.nCT_floor = msg.reader().readByte();
                ...
                else if (b3 == 2)
                {
                    ...
                    for (var i = 0; i < b5; i++)
                    {
                        var o2 = string.Concat(
                            string.Concat(
                                string.Concat(string.Empty + msg.reader().readByte() + "|", msg.reader().readUTF(),
                                    "|"), msg.reader().readShort(), "|"), msg.reader().readInt());
                        GameScr.res_CT.addElement(o2);
                    }

                    var text2 = text;
                    text = text2 + "\tsub   2|  A= " + GameScr.nCT_TeamA + "|B =" + GameScr.nCT_TeamB +
                           "  isPaint_CT=true \n";
                }
                else if (b3 == 3)
                {
    ...
    public void read_UpdateSkill(Message msg)
    {
        try
        {
            ...
            if (b == 0)
            {
                var curExp = msg.reader().readShort();
                for (var i = 0; i < Char.myCharz().vSkill.size(); i++)
                {
                    var skill = (Skill)Char.myCharz().vSkill.elementAt(i);
            ...
            {
                var b2 = msg.reader().readByte();
                for (var j = 0; j < Char.myCharz().vSkill.size(); j++)
                {
                    var skill2 = (Skill)Char.myCharz().vSkill.elementAt(j);
                    if (skill2.skillId == num)
                    {
                        for (var k = 0; k < 20; k++)
                        {
                            var imagePath = ImgByName.getImagePath("Skills_" + skill2.template.id + "_" + b2 + "_" + k,
            ...
            else
            {
                if (b != -1)
                    return;
                var skill3 = Skills.get(num);
                for (var l = 0; l < Char.myCharz().vSkill.size(); l++)
                ...
                for (var m = 0; m < Char.myCharz().vSkillFight.size(); m++)
                ...
                for (var n = 0; n < GameScr.onScreenSkill.Length; n++)
                ...
                for (var num2 = 0; num2 < GameScr.keySkill.Length; num2++)
                ...
                GameScr.info1.addInfo(
                    mResources.hasJustUpgrade1 + skill3.template.name + mResources.hasJustUpgrade2 + skill3.point, 0);
            }
        }
        catch (Exception)
        {
